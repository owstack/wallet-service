      ...
      helpers.stubUtxos(server, wallet, [1, 1], function() {
        ...
        helpers.createAndPublishTx(server, txOpts, TestData.copayers[0].privKey_1H_0, function(tx) {
          setTimeout(function() {
            ...
            var emails = lodash.map(calls, function(c) {
              return c.args[0];
            });
    ...
    it('should notify copayers a new outgoing tx has been created', function(done) {
      ...
      helpers.stubUtxos(server, wallet, [1, 1], function() {
        ...
        async.waterfall([
          ...
          setTimeout(function() {
            var calls = mailerStub.sendMail.getCalls();
            var emails = lodash.map(lodash.takeRight(calls, 3), function(c) {
              return c.args[0];
            });
    ...
    it('should notify copayers a tx has been finally rejected', function(done) {
      helpers.stubUtxos(server, wallet, 1, function() {
        ...
        async.waterfall([
          ...
          setTimeout(function() {
            var calls = mailerStub.sendMail.getCalls();
            var emails = lodash.map(lodash.takeRight(calls, 2), function(c) {
              return c.args[0];
            });
        ...
        server.createAddress({}, function(err, address) {
          ...
          server._notify('NewIncomingTx', {
            ...
            setTimeout(function() {
              ...
              var spanish = lodash.find(emails, {
              ...
              var english = lodash.find(emails, {
